...
static const cgShaderDef_t cg_renderprogs[] =
{
	...
	{
		"renderprogs/dofDownsample.pixel",
		"/*\n"
		"* See http://http.developer.nvidia.com/GPUGems3/gpugems3_ch28.html\n"
		"* Pixel shader which downsamples the buffer and initializes the CoC\n"
		"*/\n"
		"\n"
		"\n"
		"\n"
		...
		"const float2 dofRowDelta;  // float2( 0, 0.25 / renderTargetHeight )  \n"
	...
	{
		"renderprogs/dofDownsample.vertex",
		" \n"
		"\n"
