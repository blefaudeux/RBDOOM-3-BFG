...
namespace gtl
{
    ...
    public:
        ...
        static bool parse_calib_result( CalibResult & calib_result, boost::property_tree::ptree const & root,
                                        bool & has_calib_result );

        static bool parse_status_code( GazeApiStatusCode & status_code, boost::property_tree::ptree const & root );
        static bool parse_server_state( ServerState & server_state, GazeData & gaze_data, CalibResult & calib_result,
                                        Screen & screen, boost::property_tree::ptree const & root, bool& has_gaze_data,
                                        bool& has_calib_result );
